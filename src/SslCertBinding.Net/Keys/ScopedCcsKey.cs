...
{
    /// <summary>
    /// Represents the key for a scoped central certificate store SSL binding.
    /// </summary>
    public sealed class ScopedCcsKey : SslBindingKey, IEquatable<ScopedCcsKey>, IEquatable<DnsEndPoint>
    {
        private const string FormatErrorMessage = "Invalid scoped CCS binding key format.";

        /// <summary>
        /// Initializes a new instance of the <see cref="ScopedCcsKey"/> class.
        /// </summary>
        ...
        /// <inheritdoc />
        public override SslBindingKind Kind => SslBindingKind.ScopedCcs;
        ...
        public static ScopedCcsKey From(DnsEndPoint endPoint) => new(endPoint);

        /// <summary>
        /// Tries to parse a scoped CCS binding key.
        /// </summary>
        ...
        /// <summary>
        /// Parses a scoped CCS binding key.
        /// </summary>
        /// <param name="value">The textual representation of the key.</param>
