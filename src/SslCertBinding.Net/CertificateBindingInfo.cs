...
namespace SslCertBinding.Net
{
	...
	public class CertificateBindingInfo
	{
		...
		public CertificateBindingInfo(string certificateThumbprint, StoreName certificateStoreName, IPEndPoint ipPort, Guid appId, BindingOptions options = null)
			: this(certificateThumbprint, certificateStoreName.ToString(), ipPort, appId, options) { }

		public CertificateBindingInfo(string certificateThumbprint, string certificateStoreName, IPEndPoint ipPort, Guid appId, BindingOptions options = null) {
